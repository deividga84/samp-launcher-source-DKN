...
public class UpdateService extends Service {
    ...
    void startUpdating()
    {
        ...
        Volley.newRequestQueue(getApplicationContext()).add(new StringRequest("http://177.155.199.185/apigua/files/client_config.json", new Response.Listener<String>() {
            @Override
    ...
    public boolean isGameUpdateExists() {
        ...
        try {
            packageInfo = getPackageManager().getPackageInfo("com.sampmobile.game", PackageManager.GET_ACTIVITIES);
