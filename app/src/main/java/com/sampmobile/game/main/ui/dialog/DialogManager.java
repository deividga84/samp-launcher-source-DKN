package com.sampmobile.game.main.ui.dialog;
...
import com.sampmobile.game.launcher.util.CustomRecyclerView;
...
public class DialogManager {
    ...
    public void show(int i, int i2, String str, String str2, String str3, String str4) {
        ...
        if(mText.equals("") || mText.equals(" ") || mText.equals("-"))
            return;
        ...
        //OBSERVAÇÃO>>
        /*mDialogInput.postDelayed(() -> {
            mDialogInput.requestFocus();
            InputMethodManager imm = (InputMethodManager) activity.getSystemService(Context.INPUT_METHOD_SERVICE);
            if (imm != null) {
                imm.showSoftInput(mDialogInput, InputMethodManager.SHOW_IMPLICIT);
            }
        }, 200);*/
        if (mDialogStyle == DIALOG_STYLE_INPUT || mDialogStyle == DIALOG_STYLE_PASSWORD) {
            mDialogInput.postDelayed(() -> {
                mDialogInput.requestFocus();
                InputMethodManager imm = (InputMethodManager) activity.getSystemService(Context.INPUT_METHOD_SERVICE);
                if (imm != null) {
